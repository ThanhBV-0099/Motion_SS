...
#define WIFI_UART_QUEUE_LMT             16              //The size of the data receiving queue, such as the MCU's RAM is not enough, can be reduced
#define WIFI_UART_RECV_BUF_LMT          24              //According to the user's DP data size, it must be greater than 24
#else
...
#define WIFIR_UART_SEND_BUF_LMT         24              //According to the user's DP data size, it must be greater than 24
/******************************************************************************
...
//当前电流(只上报)
//Notes:
#define DPID_CUR_CURRENT 102
//当前功率(只上报)
//Notes:
#define DPID_CUR_POWER 103
//当前电压(只上报)
//Notes:
#define DPID_CUR_VOLTAGE 104
